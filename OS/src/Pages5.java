...
// to memory, where it wasn't overwritten by Page5. Page5 also checks if the data it wrote initially is the
// same data it read back. Now test FreeMemory as well to ensure the assigned memory
...
public class Pages5 extends UserlandProcess{
     ...
     * and Page5 process wasn't overwritten by Page4 process, an isolation test. It also implements a
     * test for FreeMemory.
     */
    public void main() {
